...
- [ ] [Apps] Online Mapping and Navigation in Simulation
...
You can traverse within a simulated scene supported by Habitat 3.0. The data will be published via **ROS2 topics**, which DualMap subscribes to for building the semantic map **in real time**.  
The navigational path generated by DualMap will also be published via ROS2, and the Habitat Data Collector will subscribe to this path information and control the agent to follow it.
