...
def main():
    parser = argparse.ArgumentParser(description="Calculate and aggregate performance metrics, then export to Excel.")
    parser.add_argument("output_path", type=str, help="Path to the directory containing the results.")
